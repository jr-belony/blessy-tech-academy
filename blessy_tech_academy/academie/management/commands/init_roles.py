    ...
    def handle(self, *args, **options):
        ...
        ROLES = {
            ...
            'Admin': {
                ...
                'permissions': [
                    ...
                    'view_formation', 'change_formation', 'add_formation',
                    'view_inscription',
                    'view_quiz', 'change_quiz',
                ],
            },
            'Direction': {
                'label': 'Direction',
                'permissions': [
                    'view_formation', 'view_inscription',
                    'view_statistiques',
                ],
            },
            'RespAcademique': {
                ...
                'permissions': [
                    'view_formation', 'change_formation', 'add_formation',
                    'view_module', 'change_module', 'add_module',
                    'view_lecon', 'change_lecon', 'add_lecon',
                    'view_quiz', 'change_quiz', 'add_quiz',
                ],
            },
            'Formateur': {
                'label': 'Formateur',
                'permissions': [
                    'view_formation',
                    'view_module', 'change_module',
                    'view_lecon', 'change_lecon',
                    'view_quiz',
                ],
            },
            'AsstFormateur': {
            ...
            'Marketing': {
                'label': 'Marketing',
                'permissions': [
                    'view_article', 'change_article', 'add_article',
                    'view_inscription',
                ],
            },
            'Finance': {
        ...
        for group_name, config in ROLES.items():
            ...
            if config['permissions'] == '__all__':
                ...
                self.stdout.write(f'     → {all_permissions.count()} permissions attribuées (toutes)')
            else:
                ...
                for perm_codename in config['permissions']:
                    try:
                        ...
                        self.stdout.write(self.style.WARNING(f'     ⚠️  Permission introuvable : {perm_codename}'))
