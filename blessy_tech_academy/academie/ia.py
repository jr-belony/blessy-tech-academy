...
def generer_contenu_formation(nom_formation, ecole_nom=""):
    ...
    try:
        ...
        return {'description': '', 'debouches': '', 'prerequis': '', 'certifications': '', 'erreur': str(e)}
...
def attribuer_badges(utilisateur):
    ...
    competences_badges = [
        ...
        ('expert_ia', any(m in ' '.join(formations_noms) for m in ['ia', 'intelligence artificielle', 'prompt'])),
    ]
