...
class InscriptionCompteForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["password2"].help_text = "Confirme ton mot de passe."
...
class SujetForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "contenu": CKEditor5Widget(attrs={"class": "django_ckeditor_5"}, config_name="default"),
        }
...
class ReponseForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["contenu"]
        widgets = {
            "contenu": CKEditor5Widget(attrs={"class": "django_ckeditor_5"}, config_name="minimal"),
        }
